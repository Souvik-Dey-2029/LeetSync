import { LeetSyncError } from "./util.js";
...
function sortTopicsInReadme(markdownFile) {
  ...
  if (leetCodeSection == null) throw new LeetSyncError('LeetCodeTopicSectionNotFound');
  ...
  topics = topics.map(section => {
    ...
    if (topicHeaderIndex < leetCodeSectionStartIndex) {
      ...
      if (endTopicString == null) throw new LeetSyncError('EndOfTopicNotFound');
